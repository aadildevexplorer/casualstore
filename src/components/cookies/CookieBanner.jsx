...
export default function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="w-[90%] max-w-md bg-gradient-to-r from-white via-gray-50 to-white rounded-xl shadow-2xl border border-gray-200 p-6 m-5 mt-20 flex flex-col gap-4 transition-all duration-500 relative">
        {/* Header */}
